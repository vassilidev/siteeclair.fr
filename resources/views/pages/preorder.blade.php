        ...
        <div class="container mx-auto px-4">
            ...
            <form action="{{ route('preorder.store', $offer) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label for="email" class="block text-gray-800 font-semibold mb-2">Adresse Email <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="phone" class="block text-gray-800 font-semibold mb-2">Numéro de Téléphone <span
                                    class="text-red-500">*</span></label>
                ...
                <div id="pro-fields" class="{{ old('company') ? '' : 'hidden' }} mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="siren" class="block text-gray-800 font-semibold mb-2">Numéro SIREN</label>
    ...
    <section id="contact-section" class="py-20 bg-background border-t-4 border-primary">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-center md:text-left mb-6 md:mb-0">
                <h2 class="text-2xl md:text-3xl font-bold text-primary mb-4">Des Questions Supplémentaires ? 🤔</h2>
